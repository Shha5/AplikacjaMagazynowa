...
namespace AplikacjaMagazynowaAPI_Tests.TestHelpers
{
    public static class StubsHelper
    {
        ...
        public static IEnumerable<OrderItemDataModel> GenerateStubOrderItemDataIEnum()
        {
        ...
        public static ProductDataModel GenerateStubValidProductData()
        {
        ...
        public static IEnumerable<ProductDataModel> GenerateStubValidProductDataIEnum()
        {
        ...
        public static List<ProductOutputModel> GenerateStubValidProductOutputList()
        {
